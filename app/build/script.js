	...
	_createClass(ShowInfo, [{
		...
		value: function createInfo() {
			...
			if (this.idElement !== 'point_0') {
				distanceToPoint.innerHTML = (this.orderNumber - 1) + ' -> ' + this.orderNumber + ' = ' + this.distance + 'px';
				console.log(distanceToPoint.innerText);
			}
...
arrPoint.getButton().onclick = function () {
	...
	loop = setInterval(countPointsInterval, 100);
};
